...
// CR: Both Endpoints should use a data provider to access the information.
...
public class RestWeatherCollectorEndpoint implements WeatherCollector {
    ...
    public Response updateWeather(@PathParam("iata") String iataCode,
        ...
        try {
            ...
            // CR: This exception should be logged with the appropriate level and the Response should return an error.
            e.printStackTrace();
        }
    ...
    public Response getAirport(@PathParam("iata") String iata) {
        ...
        // CR: What if no airport is found? Remember to use the appropriate HTTP response codes.
    ...
    public Response addAirport(@PathParam("iata") String iata,
        ...
        // CR: The latitude and longitude parameters should be either asked as Double values in the method declaration
        // CR: If you want to handle a possible failure, user a catch on the NumberFormatException and use the response
        // CR: code
    ...
    public Response deleteAirport(@PathParam("iata") String iata) {
        // CR: Use the method not allowed response code.
    ...
    public void addDataPoint(String iataCode, String pointType, DataPoint dp) throws WeatherException {
        // CR: For encapsulation purposes getAirportDataIdx should be moved to a data provider class.
    ...
    public void updateAtmosphericInformation(AtmosphericInformation ai, String pointType, DataPoint dp) throws WeatherException {
        ...
        // CR: What is the reason no if/else was used in this method? Or better yet, use a switch/case structure since
        // CR: you are dealing with constant values. Use DataPointType.valueOf(pointType) to obtain the constant value.
    ...
    protected static void init() {
        // CR: For clarity, it's better to use a line per statement
        ...
        try {
            ...
            // CR: This exception should be logged with the appropriate level.
            e.printStackTrace();
        }
    }
