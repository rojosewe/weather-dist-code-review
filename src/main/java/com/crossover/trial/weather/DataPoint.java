...
public class DataPoint {
    ...
    // CR: Make these private, getters are created
    ...
    static public class Builder {
        ...
        // CR: Remember to make field modifiers explicit. Getter and Setters are made, so use private for encapsulation.
        int first;
        int mean;
        int median;
        int last;
        ...
        public Builder withFirst(int first) {
            // CR:  This is a self assignation. use this.first = first;
        ...
        public Builder withMean(int mean) {
            // CR:  This is a self assignation. use this.mean= mean;
            mean = mean;
            return this;
        }

        public Builder withMedian(int median) {
            // CR:  This is a self assignation.
            median = median;
            return this;
        }
